...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Contacts::Provider
{
        ...
        impl::consume_t<IContactProvider>
    {
        ...
        IContactProvider(IContactProvider const&) noexcept = default;
        IContactProvider(IContactProvider&&) noexcept = default;
        IContactProvider& operator=(IContactProvider const&) & noexcept = default;
        IContactProvider& operator=(IContactProvider&&) & noexcept = default;
    };
