...
WINRT_EXPORT namespace winrt::Windows::Graphics::Capture
{
        ...
        impl::consume_t<IDirect3D11CaptureFrame3>
    {
        ...
        IDirect3D11CaptureFrame3(IDirect3D11CaptureFrame3 const&) noexcept = default;
        IDirect3D11CaptureFrame3(IDirect3D11CaptureFrame3&&) noexcept = default;
        IDirect3D11CaptureFrame3& operator=(IDirect3D11CaptureFrame3 const&) & noexcept = default;
        IDirect3D11CaptureFrame3& operator=(IDirect3D11CaptureFrame3&&) & noexcept = default;
    };
        ...
        impl::consume_t<IDisplayGraphicsCaptureSession>
    {
        ...
        IDisplayGraphicsCaptureSession(IDisplayGraphicsCaptureSession const&) noexcept = default;
        IDisplayGraphicsCaptureSession(IDisplayGraphicsCaptureSession&&) noexcept = default;
        IDisplayGraphicsCaptureSession& operator=(IDisplayGraphicsCaptureSession const&) & noexcept = default;
        IDisplayGraphicsCaptureSession& operator=(IDisplayGraphicsCaptureSession&&) & noexcept = default;
    };
        ...
        impl::consume_t<IGraphicsCaptureSession7>
    {
        ...
        IGraphicsCaptureSession7(IGraphicsCaptureSession7 const&) noexcept = default;
        IGraphicsCaptureSession7(IGraphicsCaptureSession7&&) noexcept = default;
        IGraphicsCaptureSession7& operator=(IGraphicsCaptureSession7 const&) & noexcept = default;
        IGraphicsCaptureSession7& operator=(IGraphicsCaptureSession7&&) & noexcept = default;
    };
