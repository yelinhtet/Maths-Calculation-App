...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(bool) Initialize(param::hstring const& clientProcessIdentifier, uint32_t clientProcessId, param::hstring const& serverProcessIdentifier, uint32_t serverProcessId, param::hstring const& serverId) const;
        WINRT_IMPL_AUTO(void) OnMessage(param::hstring const& message, winrt::Windows::AI::Agents::Mcp::McpMessageDirection const& direction, winrt::Windows::AI::Agents::Mcp::McpMessageFilterResponse const& filterResponse) const;
    };
