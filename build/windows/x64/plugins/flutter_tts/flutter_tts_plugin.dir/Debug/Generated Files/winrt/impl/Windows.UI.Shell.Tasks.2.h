...
WINRT_EXPORT namespace winrt::Windows::UI::Shell::Tasks
{
    struct __declspec(empty_bases) AppTaskContent : winrt::Windows::UI::Shell::Tasks::IAppTaskContent
    {
        ...
        AppTaskContent(AppTaskContent const&) noexcept = default;
        AppTaskContent(AppTaskContent&&) noexcept = default;
        AppTaskContent& operator=(AppTaskContent const&) & noexcept = default;
        AppTaskContent& operator=(AppTaskContent&&) & noexcept = default;
        ...
        impl::require<AppTaskInfo, winrt::Windows::UI::Shell::Tasks::IAppTaskInfo2>
    {
        ...
        AppTaskInfo(AppTaskInfo const&) noexcept = default;
        AppTaskInfo(AppTaskInfo&&) noexcept = default;
        AppTaskInfo& operator=(AppTaskInfo const&) & noexcept = default;
        AppTaskInfo& operator=(AppTaskInfo&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) AppTaskResultAsset : winrt::Windows::UI::Shell::Tasks::IAppTaskResultAsset
    {
        ...
        AppTaskResultAsset(AppTaskResultAsset const&) noexcept = default;
        AppTaskResultAsset(AppTaskResultAsset&&) noexcept = default;
        AppTaskResultAsset& operator=(AppTaskResultAsset const&) & noexcept = default;
        AppTaskResultAsset& operator=(AppTaskResultAsset&&) & noexcept = default;
    };
}
#endif
