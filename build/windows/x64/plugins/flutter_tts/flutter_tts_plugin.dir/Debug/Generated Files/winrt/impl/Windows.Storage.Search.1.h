...
WINRT_EXPORT namespace winrt::Windows::Storage::Search
{
        ...
        impl::consume_t<IQueryOptionsAdditionalSearchSources>
    {
        ...
        IQueryOptionsAdditionalSearchSources(IQueryOptionsAdditionalSearchSources const&) noexcept = default;
        IQueryOptionsAdditionalSearchSources(IQueryOptionsAdditionalSearchSources&&) noexcept = default;
        IQueryOptionsAdditionalSearchSources& operator=(IQueryOptionsAdditionalSearchSources const&) & noexcept = default;
        IQueryOptionsAdditionalSearchSources& operator=(IQueryOptionsAdditionalSearchSources&&) & noexcept = default;
    };
