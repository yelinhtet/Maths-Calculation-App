...
WINRT_EXPORT namespace winrt::Windows::Devices::Printers
{
        ...
        impl::consume_t<IIppAttributeConverterStatics>
    {
        ...
        IIppAttributeConverterStatics(IIppAttributeConverterStatics const&) noexcept = default;
        IIppAttributeConverterStatics(IIppAttributeConverterStatics&&) noexcept = default;
        IIppAttributeConverterStatics& operator=(IIppAttributeConverterStatics const&) & noexcept = default;
        IIppAttributeConverterStatics& operator=(IIppAttributeConverterStatics&&) & noexcept = default;
    };
        ...
        impl::consume_t<IPdlPassthroughProvider2>
    {
        ...
        IPdlPassthroughProvider2(IPdlPassthroughProvider2 const&) noexcept = default;
        IPdlPassthroughProvider2(IPdlPassthroughProvider2&&) noexcept = default;
        IPdlPassthroughProvider2& operator=(IPdlPassthroughProvider2 const&) & noexcept = default;
        IPdlPassthroughProvider2& operator=(IPdlPassthroughProvider2&&) & noexcept = default;
    };
