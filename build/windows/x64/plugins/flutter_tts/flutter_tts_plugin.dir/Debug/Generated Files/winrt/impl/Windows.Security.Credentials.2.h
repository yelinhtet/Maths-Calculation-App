...
WINRT_EXPORT namespace winrt::Windows::Security::Credentials
{
    struct AttestationChallengeHandler : Windows::Foundation::IUnknown
    {
        ...
        AttestationChallengeHandler(AttestationChallengeHandler const&) noexcept = default;
        AttestationChallengeHandler(AttestationChallengeHandler&&) noexcept = default;
        AttestationChallengeHandler& operator=(AttestationChallengeHandler const&) & noexcept = default;
        AttestationChallengeHandler& operator=(AttestationChallengeHandler&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) KeyCredentialCacheConfiguration : winrt::Windows::Security::Credentials::IKeyCredentialCacheConfiguration
    {
        ...
        KeyCredentialCacheConfiguration(KeyCredentialCacheConfiguration const&) noexcept = default;
        KeyCredentialCacheConfiguration(KeyCredentialCacheConfiguration&&) noexcept = default;
        KeyCredentialCacheConfiguration& operator=(KeyCredentialCacheConfiguration const&) & noexcept = default;
        KeyCredentialCacheConfiguration& operator=(KeyCredentialCacheConfiguration&&) & noexcept = default;
    };
