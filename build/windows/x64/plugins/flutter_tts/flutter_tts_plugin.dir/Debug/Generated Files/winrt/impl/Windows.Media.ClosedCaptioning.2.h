...
WINRT_EXPORT namespace winrt::Windows::Media::ClosedCaptioning
{
    ...
    struct __declspec(empty_bases) ClosedCaptionTheme : winrt::Windows::Media::ClosedCaptioning::IClosedCaptionTheme
    {
        ...
        ClosedCaptionTheme(ClosedCaptionTheme const&) noexcept = default;
        ClosedCaptionTheme(ClosedCaptionTheme&&) noexcept = default;
        ClosedCaptionTheme& operator=(ClosedCaptionTheme const&) & noexcept = default;
        ClosedCaptionTheme& operator=(ClosedCaptionTheme&&) & noexcept = default;
