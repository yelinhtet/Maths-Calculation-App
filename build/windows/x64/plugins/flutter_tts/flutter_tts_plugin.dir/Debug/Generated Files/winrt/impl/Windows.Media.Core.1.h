...
WINRT_EXPORT namespace winrt::Windows::Media::Core
{
        ...
        impl::consume_t<ICodecSubtypesStatics2>
    {
        ...
        ICodecSubtypesStatics2(ICodecSubtypesStatics2 const&) noexcept = default;
        ICodecSubtypesStatics2(ICodecSubtypesStatics2&&) noexcept = default;
        ICodecSubtypesStatics2& operator=(ICodecSubtypesStatics2 const&) & noexcept = default;
        ICodecSubtypesStatics2& operator=(ICodecSubtypesStatics2&&) & noexcept = default;
    };
